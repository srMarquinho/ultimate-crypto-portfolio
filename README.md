...
**Hundreds of transactions to add:** You'll probably be alright adding the average price you paid for each crypto in the `Transactions` tab. Unless you want a detailed summary, here is how:
